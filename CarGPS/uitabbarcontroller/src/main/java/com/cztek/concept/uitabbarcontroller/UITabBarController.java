package com.cztek.concept.uitabbarcontroller;
...
import com.cztek.concept.uitabbarcontroller.custom.UIFragmentTabHost;
import com.cztek.concept.uitabbarcontroller.utils.TintUtil;
...
public class UITabBarController extends LinearLayout {
    ...
    private UIFragmentTabHost mTabHost;
    //分割线
    ...
    public UITabBarController(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
     ...
     * @return
     */
    public UITabBarController init(FragmentManager manager) {
    ...
    public UITabBarController setOnTabChangeListener(OnTabChangeListener listener) {
        if (listener != null) {
     ...
     * @return
     */
    public UITabBarController addTabItem(String name, int imgId, Class fragmentClass) {
        return addTabItem(name, ContextCompat.getDrawable(context, imgId), fragmentClass);
    }

    public UITabBarController addTabItem(String name, int imgIdSelect, int imgIdUnSelect, Class fragmentClass) {
     ...
     * @return
     */
    public UITabBarController addTabItem(final String name, Drawable drawable, Class fragmentClass) {
    ...
    public UITabBarController addTabItem(final String name, Drawable drawableSelect, Drawable drawableUnSelect, Class fragmentClass) {
        tabIdList.add(TextUtils.isEmpty(name) ? fragmentClass.getName() : name);
        mTabHost.addTab(mTabHost.newTabSpec(TextUtils.isEmpty(name) ? fragmentClass.getName() : name)
     ...
     * @return
     */
    public UITabBarController setImgSize(float width, float height) {
        this.imgWidth = width;
     ...
     * @return
     */
    public UITabBarController setFontSize(float textSize) {
     ...
     * @return
     */
    public UITabBarController setTabPadding(float top, float middle, float bottom) {
        this.paddingTop = top;
     ...
     * @return
     */
    public UITabBarController setChangeColor(@ColorInt int selectColor, @ColorInt int unSelectColor) {
        this.selectColor = selectColor;
     ...
     * @return
     */
    public UITabBarController setTabBarBackgroundColor(@ColorInt int color) {
     ...
     * @return
     */
    public UITabBarController setTabBarBackgroundResource(@DrawableRes int resid) {
...
//    }
     ...
     * @return
     */
    public UITabBarController isShowDivider(boolean isShowDivider) {
     ...
     * @return
     */
    public UITabBarController setDividerHeight(float height) {
     ...
     * @return
     */
    public UITabBarController setDividerColor(@ColorInt int color) {
     ...
     * @return
     */
    public UITabBarController setCurrentTab(int index) {
